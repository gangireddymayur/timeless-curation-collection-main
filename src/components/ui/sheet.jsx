...
const SheetTitle = ({ className = "", ...props }) => (
  <SheetPrimitive.Title className={`text-lg font-semibold text-foreground ${className}`} {...props} />
);

const SheetDescription = ({ className = "", ...props }) => (
  <SheetPrimitive.Description className={`text-sm text-muted-foreground ${className}`} {...props} />
);
